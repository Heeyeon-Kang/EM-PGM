...
# The following R-code fits the simulation data using mvFMR with known K
# presented in Section 5.1, Section 5.2.
...
# result <- mvFMR_fixedK(X, Y, K=3)

## Assume that K=2 is known ##
mvFMR_fixedK <- function(X, Y, n=nrow(X), P=(ncol(X)-1), m=ncol(Y), K){
