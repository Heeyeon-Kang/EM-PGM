...
# pgm_result_scad_fixedK <- PGM_mvFMR_SCAD_fixedK(X, Y, K=2, eta=1, a=3.7, lambda=lambda_s)
...
PGM_mvFMR_SCAD_fixedK <- function(X, Y, n=nrow(X), P=(ncol(X)-1), m=ncol(Y), K, eta, a, lambda, maxiter=100){
