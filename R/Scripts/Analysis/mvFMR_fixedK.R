...
mvFMR_fixedK <- function(X, Y, n = nrow(X), P = (ncol(X)-1), m = ncol(Y), init = TRUE, K, maxiter = 100){
  ...
  return(list(total_w = w, total_density = density, 
              optimal = optimal, optimal_w = optimal_w, optimal_density = optimal_density,
