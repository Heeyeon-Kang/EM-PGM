...
# Data is cleaned by removing unnecessary variables and missing observations and 
# using dummy variables.
# Also, the units are different for each variable, so we center and scale the predictors.
# After data cleansing, there exists 375 samples.

diabetes_dat <- read.csv(file="./Data/diabetes_diagnosis_data.csv")
delete_columns <- c(1,5,7,12,15,16)
